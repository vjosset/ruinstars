...
import WeaponTableAlt from '../shared/WeaponTableAlt'
...
export default function UnitCardAlt2({
  unit,
  seq,
  isOwner,
  allSpecials,
      ...
      <div className="bg-card border border-main rounded relative flex flex-col h-full unitcard mx-1">
        ...
        <div className={'grid grid-cols-12 gap-1 text-center'}>
          <div className="col-span-12 p-1">
            {/* Stats */}
            <div className="grid grid-cols-6 gap-x-8 text-center">
              <div className="text-md col-span-2 border-border border">
              ...
              <div className={`text-md col-span-2 border-border border ${isOwner ? 'cursor-pointer' : ''}`} onClick={() => isOwner && setShowHITModal(true)}>
                <span className="flex items-center justify-center gap-1">
          ...
          {!unit.isUnitType && unit.hasCustomPortrait && (
            <div className="cursor-pointer col-span-3 overflow-hidden" onClick={() => onPortraitClick && onPortraitClick(unit.unitId)}>
              <img
        ...
        <div className="p-1">
          ...
          {(unit.weapons?.length ?? 0) > 0 && unit.currHIT !== 0 && (
            <WeaponTableAlt weapons={unit.weapons ?? []} MSK={unit.MSK ?? 0} RSK={unit.RSK ?? 0} allSpecials={allSpecials} />
          )}
