...
export default function QuickRef() {
  return (
    <div className="rules">
      ...
      <ol>
        <li><strong>TO</strong><br/>The Unit's Squad immediately gains 1 TO.</li>
        <li><strong>Relay Order</strong><br/>The Unit may immediately perform one free Basic or Mission Action.</li>
        <li><strong>Map</strong><br/>The Unit or one of its Squadmates may immediately perform a Move Action.</li>
        <li><strong>MedPack</strong><br/>The Unit gains a MedPack. This MedPack can be used for 1 ACT during any of this Unit's activations. When used, the Unit or an Adjacent Squadmate regain 1D3 lost HIT. The MedPack may not be used if this Unit or the selected Squadmate are Adjacent to any Enemy Units. Once used, remove the MedPack from the Unit.</li>
        <li><strong>Nothing</strong><br/>The crate is empty. Nothing happens.</li>
        <li><strong>Booby Trap</strong><br/>The crate explodes, dealing 2 Ranged Damage to all Units within 2" of its position, then it is removed from the battlefield.</li>
      </ol>
