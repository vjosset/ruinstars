      ...
      <div
        ...
        <div className="relative pt-48">
          ...
          <div className="text-center max-w-lg mx-auto noprint mt-4">
            <Button>
              <Link target="_blank" href="/assets/Ruinstars - The Rules - 20250927 - FullColor.pdf">
                <h5>Download The Rules</h5>
              </Link>
            </Button>
            <br />
            <Link className="underline" target="_blank" href="/assets/Ruinstars - The Rules - 20250927.pdf">
