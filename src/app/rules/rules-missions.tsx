  ...
  return (
    <div className="section">
      ...
      <div className="section">
        ...
        Use your own battlemats, or use our print-at-home <a className="underline" href="/tools">Battlefields</a> with tiles and grid squares sized for Paces ready to go.
