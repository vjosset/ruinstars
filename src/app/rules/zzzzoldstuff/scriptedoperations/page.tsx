...
export async function generateMetadata() {
  return generatePageMetadata({
    title: 'Campaigns and Scripted Operations',
    description: `Campaign rules and Scripted Operations for ${GAME.NAME}, a free miniatures sci-fi skirmish wargame.`,
    images: [{
      url: '/icons/icon-big.png',
    }],
    keywords: ['free', 'rules', 'pdf'],
    pagePath: '/rules/books/campaignsoperations'
  })
}

export default async function RulesCampaignsAndOperations({ searchParams }: { searchParams?: Promise<{ print?: string }> }) {
