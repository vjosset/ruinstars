    ...
    <div className="section">
      ...
      <div className="section twocols">
        ...
        <div className="section">
          ...
          A Unit may climb over a wall that is 1 Pace high by spending 2 Paces of its Movement.<br/>
          ...
          Climbing down a wall follows the same rules as climbing up, but the first vertical Pace is free.
          ...
          The moving Unit may choose to spend some or all of its remaining movement Paces to blunt the attack. For each Pace of movement it spends in this way, reduce the number of attack dice the enemy rolls (the weapon's <code>ATT</code> stat) by 1.
        ...
        <div className="section">
          ...
          If a wall that is 1 Pace or taller stands between two Units, those Units are not Adjacent.</p>
        </div>
      </div>
    </div>
  )}
