    ...
    <div className="section">
      ...
      <div className="twocols">
        <div className="section">
          <h3>What You Need</h3>
          <ul>
            <li>8 miniatures to represent 2 Squads of 4 Units each. Use the starting squad below.</li>
        ...
        <div className="section">
          ...
          <ul>
            ...
            <li>Build your Squad for your preferred <a className="underline" href="/rules#buildingsquad">Faction</a></li>
            <li>Try one of the <a className="underline" href="/rules#missions">Core Missions</a> or a <a className="underline" href="/rules#scriptedoperations">Scripted Operation</a>, or start your own epic <a className="underline" href="/rules#campaigns">Campaign</a></li>
          </ul>
        ...
        <div className="section">
          ...
          <ol>
            ...
            <li>
              ...
              These actions can occur in any order, but remember that repeating the same action during an activation costs one additional ACT.
