      ...
      <div className="section twocols">
        ...
        <table>
          ...
          <tbody>
            ...
            */}
            <tr><th>Move</th><td className="text-center">1</td><td>The Unit <a className="underline" href="#movement">moves</a> up to 6".</td></tr>
            <tr><th>Dash</th><td className="text-center">1</td><td>The Unit moves up to 2". This movement follows the same rules as a <a className="underline" href="#movement">normal Move</a>.</td></tr>
            ...
            <tr><th>Pick Up</th><td className="text-center">1</td><td>The Unit picks up an Adjacent marker or token it controls.</td></tr>
            ...
            <tr><th>Give</th><td className="text-center">1</td><td>The Unit passes a marker or token it is carrying to an Adjacent Squadmate it controls.</td></tr>
        ...
        <ul>
          <li><strong>Leader:</strong><br/>
            If the Squad's Leader is still Standing, roll <strong>5 TO dice</strong>.<br/>
            If the Squad's Leader has been Taken Out, roll <strong>3 TO dice</strong>.
          </li>
          <li><strong>Taken Out:</strong> For each Unit that was Taken Out during the Mission, the Squad gains 1 additional Tactical Order (e.g. if 2 Units were Taken Out, the Squad gains 2 Tactical Orders on top of the results of the roll).</li>
        </ul>
        ...
        <div className="nopagebreak">
          ...
          <ul>
            ...
            <li>
              ...
              Modifying a die roll in this way does not trigger roll-specific effects (e.g. reducing an Attack die roll of <code>2</code> to <code>1</code> does not turn it into Critical success).
            </li>
