        ...
        <div className="twocols">
          <div className="section">
            ...
            <div className="section">
              ...
              <ul>
                <li>
                  <PDFLink href="/assets/PvE Missions - Ruinstars.pdf" title="PvE Missions" />
                  is the recommended next step for most players.
                ...
                <li>
                  <PDFLink href="/assets/PvP Missions - Ruinstars.pdf" title="PvP Missions" />
                  pits two players head-to-head with their own custom squads across a set of competitive missions with their own campaign structure.
                  Pick this up if you want to test your squad-building and tactics against another player.
                </li>
                <li>
                  <PDFLink href="/assets/Horde Mode - Ruinstars.pdf" title="Horde Mode" />
                  is a standalone survival experience where your squad faces escalating waves of enemies with no extraction — just how long can you last?
