      ...
      <div className="section twocols">
        ...
        <table>
          ...
          <tbody>
            ...
            <tr><th>Dash</th><td className="text-center">1</td><td>The Unit moves up to 2", following the same rules as a <a className="underline" href="#movement">Move</a>.</td></tr>
        ...
        <p>At the start of each turn, each player rolls <code>3D{GAME.DICE_BASIS}</code> and adds 1 die for each of the Squad's Units' <code>Leader x</code> Special Rule. For example, if your Leader is still Standing and has <code>Leader 2</code>, you would roll <code>5D{GAME.DICE_BASIS}</code> for Tactical Orders (3 base dice for Tactical Orders plus 2 dice provided by your Leader).<br/>
        ...
        <p>For each die result of <code>1-3</code>, you will have one Tactical Order. Tactical Orders may be used by Units to perform more Actions than their <code>ACT</code> Action limit.</p>
        ...
        <div className="nopagebreak">
          ...
          <ul>
            ...
            <li>Re-roll any one die for any of your rolls (including during one of your opponent's Units' Activations, for example an Armor roll during Melee combat).</li>
            <li>
