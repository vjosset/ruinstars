  ...
  return (
    <div className="section">
      ...
      <div className="section twocols">
        ...
        <p>At the start of each turn, each player rolls <code>3D{GAME.DICE_BASIS}</code> and adds 1 die for each of the Squad's Units' <code>Leader x</code> Special Rule. For example, if your Leader is still in play and has <code>Leader 2</code>, you would roll <code>5D{GAME.DICE_BASIS}</code> for Tactical Orders (3 base dice for Tactical Orders plus 2 dice provided by your Leader).<br/>
