...
description: "Trying different approaches to custom dice."
tags: ["crafting", "dice"]
...
I tried two different approaches: STLs for the actual dice, and using stencils to paint dice blanks.
...
I built STLs for the dice and tried different approaches to printing. I have an FDM printer but no resin printer.
...
I did try orienting the die so that it was "pointing down" + supports, but I could not get a good print. I'lll keep trying but I'm running out of ideas.
...
I built a different STL for a box that can hold six dice blanks and a stencil that fits into that rig.
This worked _pretty_ well, although the tolerances on my prints and the variations in the diec blanks' sizes meant that there was some bleed-through and some imprecise numbers. But the effect kind of works for Ruinstars: We get that "grungy" feeling to the numbers.
...
All in all, I like the stenciled blanks best. It's not too difficult, the stencil and rig are reusable (and fast to re-print if needed) and dice blanks are cheap.

#### Files and Links

- [Dice Stencil Rig STL]()
- [Dice STL]()
